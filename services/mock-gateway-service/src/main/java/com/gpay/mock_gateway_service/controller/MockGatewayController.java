...
public class MockGatewayController {
	...
	@PostMapping("/top-up")
	public ResponseEntity<MockGatewayTopUpResponse> topUp(@Valid @RequestBody MockGatewayTopUpRequest request) {
		return ResponseEntity.ok(mockGatewayTopUpService.topUp(request));
	}
}

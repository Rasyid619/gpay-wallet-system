...
/* Validates internal service-to-service auth tokens. */
@Service
public class InternalUserAuthenticationService {
	...
	public void validate(String providedInternalToken) {
		if (internalToken == null || internalToken.isBlank()) {
			throw new InternalAuthenticationException("Internal auth token is not configured");
		}
